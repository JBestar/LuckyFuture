            ...
            lock (AppConfig._lockObj)
            {
                ...
                foreach (PayoffLossInfo lossInfo in CurRangeList)
                {
                    ...
                    lossConf = new PayoffLossInfo
                    {
                        ...
                        Param2 = lossInfo.Param2,
                        ActionDelete = lossInfo.ActionDelete
                    };
                    rangeCollection.Add(lossConf.Enabled.ToString() + "#" + lossConf.Amount.ToString() + "#" + lossConf.Rate.ToString() + "#" + lossConf.Param + "#" + lossConf.Param2);
...
//             }
        ...
        private void dgvRangeInfo_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            if (dgvRangeInfo.CurrentCell.ColumnIndex == 2 || dgvRangeInfo.CurrentCell.ColumnIndex == 4 || dgvRangeInfo.CurrentCell.ColumnIndex == 6 || dgvRangeInfo.CurrentCell.ColumnIndex == 7) //Amout Or Rate Or Param Or Param2
            {
